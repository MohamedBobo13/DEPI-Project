...
namespace OnlineEducationPlatform.BLL.Manager.ExamResultmanager
{
    public class examresultmanager : IExamResultmanager
    {
        ...
        public async Task<ServiceResponse<Examresultwithoutiddto>> CreateexamresultAsync(Examresultwithoutiddto examresultwithoutiddto)
        {
            ...
            var response = new ServiceResponse<Examresultwithoutiddto>();
            ...
            if (saveresult)
            {
                response.Data = new Examresultwithoutiddto
                {
        ...
        public async Task<ServiceResponse<List<Examresultreaddto>>> GetAllExamResults()
        {
            var response = new ServiceResponse<List<Examresultreaddto>>();
            try
            {
                ...
                else
                {
                    ...
                    response.Data = _mapper.Map<List<Examresultreaddto>>(ExamResults);
        ...
        public async Task<ServiceResponse<List<Examresultwithoutiddto>>> GetAllSoftDeletedexamresultsAsync()
        {
            var response = new ServiceResponse<List<Examresultwithoutiddto>>();
            try
            {
                ...
                else
                {
                    ...
                    response.Data = _mapper.Map<List<Examresultwithoutiddto>>(examresults);
        ...
        public async Task<ServiceResponse<List<Examresultreaddto>>> GetstudentresultsByExamIdAsync(int examid)
        {
            var response = new ServiceResponse<List<Examresultreaddto>>();
            try
            {
                ...
                else
                {
                    ...
                    response.Data = examresults.Select(e => new Examresultreaddto
                    {
                        id = e.Id,
        ...
        public async Task<ServiceResponse<List<Examresultreaddto>>> GetStudentresultssByStudentIdAsync(string studentId)
        {
            var response = new ServiceResponse<List<Examresultreaddto>>();
            try
            {
        ...
        public async Task<ServiceResponse<bool>> updateexamresultbyid(updateexamresultdto examresultreaddto)
        {
            var response = new ServiceResponse<bool>();
            try
            {
