...
namespace OnlineEducationPlatform.BLL.Manager.QuizResultManager
{
    public class QuizResultManager : IQuizResultManager
    {
        ...
        public async Task<ServiceResponse<bool>> updatequizresultbyid(UpdateQuizzResultVm quizresultreaddto)
        {
            var response = new ServiceResponse<bool>();
            try
            {
        ...
        Task<ServiceResponse<List<QuizResultManager>>> IQuizResultManager.GetAllQuizResults()
        {
