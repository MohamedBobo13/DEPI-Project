...
using OnlineEducationPlatform.BLL.Services.ExamResultService;
...
namespace OnlineEducationPlatform.Api
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //Registering ExamResultRepo,Service
            builder.Services.AddScoped<IExamResultService, IExamResultService>();
